    ...
    if ($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if (!empty($first_name) && !empty($last_name) && !empty($contact) && !empty($username) && !empty($password)) {
            ...
            try{
                ...
                echo "<div style='font-family: Arial, sans-serif; max-width: 500px; margin: 60px auto; padding: 25px; border-radius: 8px; text-align: center; border-top: 5px solid #e50027; border-bottom: 5px solid #e50027;'>";
